...
public class UpdateMedicalEvaluation extends Command {
    ...
    public UpdateMedicalEvaluation(ServicesId servicesId, ReservesId reservesId, MedicalEvaluation medicalEvaluation) {
