...
public class AddMedicalEvaluation extends Command {

    private final ServicesId servicesId;
    private final ReservesId reservesId;
    private final MedicalEvaluation medicalEvaluation;

    public AddMedicalEvaluation(ServicesId servicesId, ReservesId reservesId, MedicalEvaluation medicalEvaluation) {
